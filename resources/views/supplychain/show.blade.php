                ...
                <div class="product-meta">
                    <div>
                        ...
                        <p class="product-serial">
                            <span class="material-symbols-outlined" style="font-size:15px; vertical-align:middle;">barcode_scanner</span>
                ...
                <table class="parts-table">
                    ...
                    <tbody>
                        ...
                        <tr data-part-id="{{ $part->id }}">
                            <!-- Image -->
                            <td>
                                <div class="row-img" style="background-image: url('{{ asset('uploads/parts/' . $part->image) }}')"></div>
                            </td>
                            <!-- Name -->
                            <td>
            ...
            document.querySelectorAll('.part-checkbox').forEach(checkbox => {
                checkbox.addEventListener('change', function () {
                    ...
                    if (this.checked) {
                        ...
                        if (qtyBadge) { qtyBadge.style.display = 'inline-flex'; }
