...
<body>
    ...
    <div class="container">
        ...
        <div class="request-card">
            ...
            @if ($errors->any())
                <div
                    style="background: #fee2e2; color: #b91c1c; padding: 15px; border-radius: 8px; margin-bottom: 20px; border: 1px solid #f87171;">
                    <ul>
            ...
            <form action="{{ route('send.message') }}" method="POST" enctype="multipart/form-data"
                ...
                <div id="product-display" class="product-preview"
                    style="display:none; margin: 20px 0; padding: 15px; border: 1px dashed #ccc; background-color: #f9f9f9;">
                    ...
                    <div style="display: flex; gap: 20px; align-items: flex-start;">
                        ...
                        <div>
                            ...
                            <div id="error-guide"
                                style="display:none; margin-top: 10px; font-size: 0.9em; background: #fff; padding: 10px; border-radius: 5px; border: 1px solid #eee;">
                                <p style="margin-bottom: 5px; color: #d32f2f; font-weight: bold;"><i
                                        class="fas fa-info-circle"></i> Common Error Codes:</p>
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($msg->warranty_image)
                                    <a href="{{ asset('storage/' . $msg->warranty_image) }}" target="_blank">View
                                        Card</a>
                                @endif
                            </td>
